...
public class CxcHisRepository : ICxcHisRepository
{
    ...
    {
        var entity = await _context.TBCXCHIS.FirstOrDefaultAsync(
            c =>
                c.CiaCodigo == ciaCodigo
                && c.OfiCodigo == ofiCodigo
                && c.MonCodigo == monCodigo
        ...
        _context.TBCXCHIS.Remove(entity);
        await _context.SaveChangesAsync(ct);
        _logger.LogInformation(
            "CXC historico eliminado: Compania={Compania}, Oficina={Oficina}, Moneda={Moneda}, Modulo={Modulo}, Tipo={Tipo}, Codigo={Codigo}, Ano={Ano}, Numero={Numero}, Secuencia={Secuencia}, Subsec={Subsec}",
            ciaCodigo,
            ofiCodigo,
            monCodigo,
            cchModulo,
