...
public class DetMovCxcService : IDetMovCxcService
{
    ...
    )
    {
        try
        {
            ...
            if (!deleted)
                return new ApiResponse<bool>(false, "Detalle movimiento CXC no encontrado")
                {
                    StatusCode = 404,
                };
            ...
            return new ApiResponse<bool>(
                true,
                "Detalle movimiento CXC eliminado exitosamente",
                true
            )
            {
                StatusCode = 200,
        ...
        catch (DbUpdateException ex)
        {
            _logger.LogWarning(
                ex,
                "Error de BD al eliminar detalle movimiento CXC {CiaCodigo}/{OfiCodigo}/{MonCodigo}/{TdcTipo}/{TdcCodigo}/{DxcAno}/{CmcNumero}/{DmcSecuencia}",
                ciaCodigo,
                ofiCodigo,
                monCodigo,
                tdcTipo,
        ...
        catch (Exception ex)
        {
            _logger.LogError(
                ex,
                "Error al eliminar detalle movimiento CXC {CiaCodigo}/{OfiCodigo}/{MonCodigo}/{TdcTipo}/{TdcCodigo}/{DxcAno}/{CmcNumero}/{DmcSecuencia}",
                ciaCodigo,
                ofiCodigo,
                monCodigo,
                tdcTipo,
