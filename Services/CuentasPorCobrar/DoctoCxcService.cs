...
public class DoctoCxcService : IDoctoCxcService
{
    ...
    )
    {
        try
        {
            ...
            if (!deleted)
                return new ApiResponse<bool>(false, "Documento CXC no encontrado")
                {
                    StatusCode = 404,
                };

            return new ApiResponse<bool>(true, "Documento CXC eliminado exitosamente", true)
            {
                StatusCode = 200,
            };
        }
        catch (DbUpdateException ex)
        {
            _logger.LogWarning(
                ex,
                "Error de BD al eliminar documento CXC {CiaCodigo}/{OfiCodigo}/{MonCodigo}/{TdcTipo}/{TdcCodigo}/{DxcAno}",
                ciaCodigo,
                ofiCodigo,
                monCodigo,
                tdcTipo,
        ...
        catch (Exception ex)
        {
            _logger.LogError(
                ex,
                "Error al eliminar documento CXC {CiaCodigo}/{OfiCodigo}/{MonCodigo}/{TdcTipo}/{TdcCodigo}/{DxcAno}",
                ciaCodigo,
                ofiCodigo,
                monCodigo,
                tdcTipo,
