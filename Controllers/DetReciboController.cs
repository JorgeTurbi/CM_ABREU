...
[Authorize]
public class DetReciboController : ControllerBase
{
    private readonly IDetReciboService _service;

    public DetReciboController(IDetReciboService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] TBDETRECIBODto dto)
    {
