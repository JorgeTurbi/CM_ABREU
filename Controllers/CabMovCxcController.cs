...
[Authorize]
public class CabMovCxcController : ControllerBase
{
    private readonly ICabMovCxcService _service;

    public CabMovCxcController(ICabMovCxcService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] TBCABMOVCXCDto dto)
    {
